...
public class ReportCustomerRmPerformance {

	private String country;
	private String first_Name;
	private String last_Name;
	private Integer customer_accounts;
	...
	public ReportCustomerRmPerformance() {
		super();
	...
	public Integer getCustomer_accounts() {
		return customer_accounts;
	}

	public void setCustomer_accounts(Integer customer_accounts) {
	...
	public String toString() {
		return "ReportCustomerRmPerformance [country=" + country + ", first_Name=" + first_Name + ", last_Name="
				+ last_Name + ", customer_accounts=" + customer_accounts + ", trxn_Count=" + trxn_Count
