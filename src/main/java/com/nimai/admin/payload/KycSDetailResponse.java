...
public class KycSDetailResponse
{
    ...
    public KycSDetailResponse( Integer kycid,  String docName,  String country,  String sourceDetails,String source,  String kycType,  String docType,  String reason,  String kycStatus,  String checkerComment,  String encodedFileContent
    		,int isAssociated,String cuType,String rmDetails,String rmFirstName,String rmlastName,String rmDesignation) {
        this.kycid = kycid;
        this.docName = docName;
        this.country = country;
        this.sourceDetails = sourceDetails;
